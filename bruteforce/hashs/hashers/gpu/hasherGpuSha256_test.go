...
var hasherSha256 = NewHasherGpuSha256()

func TestHasherGpuSha256_Hash_WithSimpleWord(t *testing.T) {
	testHashGpuSha256(t, hasherSha256, []string{"test"}, []string{"9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"})
}

func TestHasherGpuSha256_Hash_WithMultipleWord(t *testing.T) {
	testHashGpuSha256(t, hasherSha256,
		[]string{"test1", "test2"},
...
func TestHasherGpuSha256_Hash_WithUnicodeWord(t *testing.T) {
	testHashGpuSha256(t, hasherSha256, []string{"ありがとう &!ç"}, []string{"f89eddccb44ae418616060aefe3ca6604d49bc3d0e37e75167333d498532d7aa"})
}

func TestHasherGpuSha256_ProcessWithWildcard_WithSimpleWord(t *testing.T) {
	var result = hasherSha256.ProcessWithWildcard([]string{"e", "f"}, "", "", 1, "3f79bb7b435b05321651daefd374cdc681dc06faa65e374e38337b88ca046dea.Gt4wp0dJk5qWRaumcfqazMMCAxxerGi")
	assertResultGpuSha256(t, result, "e")
}

func TestHasherGpuSha256_ProcessWithWildcard_WithSaltBefore(t *testing.T) {
	var result = hasherSha256.ProcessWithWildcard([]string{"d", "e"}, "t", "", 1, "2d6c9a90dd38f6852515274cde41a8cd8e7e1a7a053835334ec7e29f61b918dd")
	assertResultGpuSha256(t, result, "e")
}

func TestHasherGpuSha256_ProcessWithWildcard_WithSaltAfter(t *testing.T) {
	var result = hasherSha256.ProcessWithWildcard([]string{"d", "e", "f"}, "", "t", 1, "9adf009b9ea42792e73e5dc86e9c9024489d74ad894c0a3acbc03095158eaabc")
...
func TestHasherGpuSha256_Hash_ConsistencyWithSameHash(t *testing.T) {
	...
	var firstResult = gpuSha256ToString(hasherSha256.Hash([]string{testString})[0])

	for i := 0; i < 10; i++ {
		var anotherResult = gpuSha256ToString(hasherSha256.Hash([]string{testString})[0])
